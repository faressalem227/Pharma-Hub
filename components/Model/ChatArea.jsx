...
import {transcripeUrl, streamBaseUrl, sqlUrl} from "../../utilities/api"
        ...
        {item.isUser ? (
          ...
          >
            ...
            <Text
              style={[
                styles.messageText,
                { color: "#FFFFFF",backgroundColor:"#3C9D8D" } 
              ]}
            >
    ...
    <View style={styles.chatArea}>
      ...
      <View style={styles.inputContainer}>
        ...
        //   onPressOut={handleMicPressOut}
          ...
          className="bg-[#3C9D8D] rounded-full p-3 justify-center items-center mr-2"
        >
